...
![image](https://github.com/Costas-Lemonis/Digital-Storytelling-Individual-Assignment/assets/100446886/22dcb0c8-0d81-4a85-aa7c-62f6f5f52d06)
 Μετά έκανα κάποια animations για τα Robot όπως να χαιρετάει και κουνάει τα χεριά του μετά έκανα ένα καινούργιο Project και άρχισα να φτιάχνω την σκηνή μου, στο Blender έκανα την βασική σκηνή και τα textures και τα πέρασα στο Unity. ![image](https://github.com/Costas-Lemonis/Digital-Storytelling-Individual-Assignment/assets/100446886/031c2e6d-3082-473e-bb3d-4eaeaff9d75d)
 ![image](https://github.com/Costas-Lemonis/Digital-Storytelling-Individual-Assignment/assets/100446886/3f53054b-e211-4a42-a4f4-c3190ebeef72)
![image](https://github.com/Costas-Lemonis/Digital-Storytelling-Individual-Assignment/assets/100446886/7fdde6da-1cd9-4165-9d85-8271114761d6)
![image](https://github.com/Costas-Lemonis/Digital-Storytelling-Individual-Assignment/assets/100446886/ccf56fa7-b4e1-4e52-a5ea-7ffd83bec6e9)
![image](https://github.com/Costas-Lemonis/Digital-Storytelling-Individual-Assignment/assets/100446886/60e731f6-ef3c-4887-91b8-e48a9a172e90)

Τέλος με τους τρόπους που μάθαμε στα προηγούμενα Deliverables έβαλα Virtual Cameras και Particle Effects αλλά λόγω χρόνου δεν έδωσα αρκετή έμφαση.

# Conclusions
Ήταν ένα καλό μάθημα για το animation ειδικά στα πρώτα δυο Deliverables, στο τρίτο απλά δεν μπόρεσα να κάνω κάτι καλό λόγω χρόνου(πολλές ασκήσεις από άλλα μαθήματα) οπότε το έκανα σε μισή μέρα όλο από τα μοντέλα μέχρι το render. 
